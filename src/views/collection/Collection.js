...
class Collection extends Component {
  ...
  render() {
    ...
    if (this.state.collection.uid) {
      return (<View classNames="p-coll">
        <div className="p-coll_breadcrumb-wrapper"></div>
        <div className={`p-coll_title-container ${this.state.collection.style['title-section'] || ''}`}>
          <div className="p-coll_title-wrapper">
            <h1 className={`p-coll_title ${this.state.collection.style.title || ''}`}>
        ...
        <div>
          <span className="li-down-open-big"></span>
        </div>
