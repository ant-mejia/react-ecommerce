...
class ProductGallery extends Component {
  constructor(props) {
    super(props);
    this.preState = {};
    this.state = { products: [], options: this.props.actions.getCache('productGalleryOptions') || {}, config: this.props.actions.getStore('config.productGallery'), range: { value: { min: 0, max: 500 }, scope: { min: 0, max: 500 } } };
